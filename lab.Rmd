...
Proposed criteria **for exploratory analysis.**

-   Have not raised more than 100M in any round
-   Remove 1% and 99% of a variable (e.g. `RAISED_AMOUNT_USD`)
...
fig=cats %>% 
  ...
  labs(
    ...
    title='Top 1% Categories in Series A Rounds') +
  coord_flip()
#ggsave(fig, filename='plots/top_cats_by_investors_seriesa.pdf',width=10)
